...
function CartSvg({ height, width }) {
    return (
        <div>
            <svg className="go414717972" width={`${width ? width : "18"}`} height={`${height ? height : "16"}`} viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
